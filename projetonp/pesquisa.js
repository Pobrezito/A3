    ...
    switch(input) {
        case "python":
            languageDetails.innerHTML += `
                ...
                <div class="language-details">
                    <img src="pythonlogo.png" alt="Python Logo" class="language-symbol">
        ...
        case "javascript":
            languageDetails.innerHTML += `
                <h2>JavaScript</h2>
                <div class="language-details">
                    <img src="jslogo.png" alt="JavaScript Logo" class="language-symbol">
        ...
        case "java":
            languageDetails.innerHTML += `
                <h2>Java</h2>
                <div class="language-details">
                    <img src="javalogo.png" alt="Java Logo" class="language-symbol">
        ...
        case "ruby":
            languageDetails.innerHTML += `
                <h2>Ruby</h2>
                <div class="language-details">
                    <img src="rubylogo.png" alt="Ruby Logo" class="language-symbol">
